	...
	<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a href="/webdinsos/home" class="logo"><img src="<?= BASEURL;?>/LOGO.png" alt="" ></a>		
				</div>
...
<div class="row">
	...
	$data = mysqli_query($conn,"SELECT * FROM artikel");
	 foreach($data as $dt ) : ?>
                    <div class="col-md-4">
						<div class="post">
                        <a class="post-img" href="/webdinsos/home/berita/<?=$dt["artikel_id"];?>"><img src="<?= BASEURL;?>/uploads/<?= $dt['gambar'];?>" style="width: 260px; height: 200px;" alt="">
						<h5 class="post-title"><?= substr($dt['judul'],0,65);?>...<a href="/webdinsos/home/berita/<?= $dt["artikel_id"];?>"></a></h5></a>	
												<div class="post-body">
								<div class="post-meta">
	...
	<?php endforeach; ?>
					...
					<div class="post post-widget">
						...
						<div class="aside-widget">
							...
							<ul>
									<li><a href="" class="cat-1"><span></span></a></li>
									</ul>
							</div>
							</div>
						</div>
